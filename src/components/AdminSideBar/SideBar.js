    ...
    <div className='sidebar'>
      ...
      <div className='menu-container-seller'>
        ...
        <ul className='menuList'>
          ...
          <li className='itemList1'><Link style={{textDecoration:'none'}} className='headingSeller' to='/Admintrends'>TRENDS</Link></li>
          <li className='itemList1'><Link style={{textDecoration:'none'}} className='headingSeller' to='/Admincontact'>CONTACT</Link></li>
        </ul>
      </div>
